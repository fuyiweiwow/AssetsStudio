...
2026-09-08 最新检查点：已继续到 Actor93 隔离三维对照。修复背面平滑误涂腿间背景及头宽审计误计拇指的问题；Hunyuan 20/40 步均完成四向渲染但未通过原始拓扑门，当前不绑定或入库。结果、限制和换机复现见 [Actor93 形体对照](ACTOR93_SHAPE_PROBE_20260908.md)。下文 2026-09-07 背面停点为此前记录，以本段为当前状态。
