...
2026-09-08 未绑定后续：原始形体已保留，新增 50000 面静态/绑定准备副本，导出后结构门全通过，四向轮廓平均 IoU 0.999860。当前 Actor 腰部已重新测量，复用腰带腰包的静态试装尚未通过槽位边界，不能入库；没有套用旧 Actor 槽位/骨骼。详情和下一步见 [未绑定交接](ACTOR_OFFLINE_STATIC_HANDOFF_20260908.md)。
