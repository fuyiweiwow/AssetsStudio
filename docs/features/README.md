...
每个主要功能开始前，从 `docs/templates/FEATURE_TEMPLATE.md` 创建独立文档，并在此登记。
...
| `F002` | Actor 专用 GarmentCode 短袖 | `provisional` | [`F002-actor-garmentcode-short-sleeve.md`](F002-actor-garmentcode-short-sleeve.md) |
