...
| 2026-08-24 | 将 ComfyUI/Python 从旧机绝对路径改为参数、环境变量和同级目录自动发现；ModelScope 重建三个 FLUX.2 文件 | 支持只远程访问的新机器，不把旧机盘符当成工作流合同 | RTX 5070 Ti 上完成作业 `84169b5e`；4-step Prompt 为 6.21s，模型与桥接通过 |
