...
def main() -> int:
    ...
    for side in ("L", "R"):
        ...
        if has_blink_states:
            ...
            surface["assetsstudio_blink_material_closed"] = f"EyeAssemblyV1_Closed_{side}"
            surface["assetsstudio_blink_contract"] = "open_half_closed_half_open"
    ...
    configure_lighting(scene, actor_center, "soft_flat")
