...
The first default `EarPair`, `head_hair` and `torso_outer` have passed rest and Walk attachment review. Their generated GLB/Blend and action renders remain reproducible workspace artifacts; this tracked package preserves their visual source and validation contracts.
